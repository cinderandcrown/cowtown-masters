    ...
    <div className="relative min-h-screen bg-gradient-to-b from-background to-muted flex flex-col items-center justify-center px-4 pb-12">
      ...
      <div className="text-center mb-10 mt-8">
        <div className="mb-4 flex justify-center">
          <img src="https://media.base44.com/images/public/69bd90cf71e1b676eaaeb41f/8e7da5470_generated_image.png" alt="Cowtown Masters" className="w-36 h-36 object-contain" />
        </div>
